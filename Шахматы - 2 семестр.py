...
class Game:
    ...
    def check_check(self):  # Проверка на шах
        ...
        if self.сan_see_king(kingDict[WHITE], pieceDict[BLACK]):
            self.message = "Шах игроку белых фигур!"
        if self.сan_see_king(kingDict[BLACK], pieceDict[WHITE]):
            self.message = "Шах игроку чёрных фигур!"

    def сan_see_king(self, kingpos, piecelist):  # проверяет, могут ли какие-либо фигуры в списке фигур
